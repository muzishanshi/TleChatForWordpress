...
<head>
  <meta charset="utf-8">
  <title><?=get_option('blogname');?>聊天室</title>
  ...
  <link rel="stylesheet" href="<?=plugins_url();?>/TleChat/chat/ui/css/amazeui.min.css"/>
  <link rel="stylesheet" href="<?=plugins_url();?>/TleChat/chat/ui/css/admin.css"  media="all">
  <style type="text/css">
...
<header class="am-topbar am-topbar-inverse admin-header">
  <div class="am-topbar-brand">
	<?php if($uid){$nickname=$rowUser->display_name;}?>
    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      ...
      <div class="am-panel am-panel-default admin-sidebar-panel">
        <div class="am-panel-bd">
          ...
          <p><?=$chat_configs["notice"]?$chat_configs["notice"]:"时光静好，与君语；细水流年，与君同。";?></p>
        </div>
  ...
  <div class="admin-content">
    ...
    <footer class="admin-content-footer">
      <p class="am-padding-left">
		CopyRight©<?=date("Y");?> <a href="<?php echo home_url(); ?>"><?php echo get_option('blogname'); ?></a> Powered by <a href="http://www.emlog.net/" title="Emlog" rel="nofollow">Emlog</a> Plugin By <a id="rightdetail" href="http://www.tongleer.com" title="同乐儿">Tongleer</a>
	  </p>
    </footer>
  </div>
  <!-- content end -->
...
<script src="<?=plugins_url();?>/TleChat/chat/ui/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->
<script src="<?=plugins_url();?>/TleChat/chat/ui/js/amazeui.min.js"></script>
  
<div id="recordingslist"></div>
<script src="https://cdn1.lncld.net/static/js/av-min-1.0.0.js"></script>
<script src="<?=plugins_url()."/TleChat/chat/js/leancloud/dist/realtime.browser.min.js";?>"></script>
<script src="<?=plugins_url()."/TleChat/chat/js/leancloud/plugins/typed-messages/dist/typed-messages.min.js";?>"></script>
<script>
	Push.Permission.request();

	var roomId = '<?=$config_room["objectId"];?>';
	var appId = '<?=$chat_configs["appId"];?>';
	var appKey = '<?=$chat_configs["appKey"];?>';
	  ...
	  */
	  ...
	  if(!isBefore){
		Push.create($("title").html(), {
			body: pushBody,
			icon: '<?=plugins_url();?>/TleChat/chat/ui/images/icon.png',
			timeout: 8000,
			vibrate: [100, 100, 100],    
			onClick: function() {
				console.log(this);
